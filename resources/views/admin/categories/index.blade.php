...
<div class="adm">
  <div class="adm-card">
    ...
    <div class="adm-card-header">
      <div>
        <div class="adm-card-title">🏷️ Daftar Kategori</div>
        <div class="adm-card-sub">Kelola kategori menu catering</div>
      </div>
    ...
    <div class="adm-table-wrap">
      <table class="adm-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div style="display:flex;align-items:center;gap:12px;">
                {{-- <div class="cat-avatar">{{ strtoupper(substr($category->name, 0, 1)) }}</div> --}}
            ...
            <td style="text-align:center;">
              <span style="background:var(--surface2);border:1px solid var(--border-md);border-radius:99px;padding:3px 12px;font-size:12px;font-weight:700;color:var(--text2);">
                {{ $category->menus_count ?? $category->menus?->count() ?? 0 }} menu
              </span>
            </td>
            <td style="text-align:center;">
              <div class="action-group" style="justify-content:center;">
                <a href="{{ route('admin.categories.edit', $category->id) }}" class="btn btn-primary btn-sm">✏️ Edit</a>
          ...
          @empty
          <tr>
            <td colspan="5" style="padding:60px 24px;text-align:center;color:var(--text3);">
              <div style="font-size:32px;margin-bottom:10px;">🏷️</div>
              <div style="font-weight:700;color:var(--text2);margin-bottom:4px;">Belum ada kategori</div>
              <div style="font-size:12px;">Tambahkan kategori untuk mengelompokkan menu</div>
            </td>
          </tr>
          @endforelse
        </tbody>
